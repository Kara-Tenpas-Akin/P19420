...
class RFM69(object):
    def __init__(self, freqBand, nodeID, networkID, isRFM69HW = False, intPin = 18, rstPin = 10, spiBus = 0, spiDevice = 0):
        ...
        print("Done setting up GPIO pins")
        ...
        print("Done initializing SPI")

        # Hard reset the RFM module
        print("Hard resetting RFM Module")
        GPIO.output(self.rstPin, GPIO.HIGH);
        time.sleep(0.1)
        GPIO.output(self.rstPin, GPIO.LOW);
        time.sleep(0.1)
        print("Done hard resetting RFM Module")

        #verify chip is syncing?
        print("Verifying chip is syncing")
        ...
        print("Done verifying chip is syncing")
